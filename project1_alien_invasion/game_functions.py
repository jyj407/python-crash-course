...
def check_events(ai_settings, screen, sb, stats, play_button, ship, aliens,
        bullets):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(ai_settings, screen, sb, stats, play_button,
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship,
    ...
    if len(aliens) == 0:
        # If the entire fleet is destoryed, start a new level.
        bullets.empty()
...
def ship_hit(ai_settings, stats, screen, ship, aliens, bullets):
    ...
    if stats.ship_left > 0:
        # Decrement ship left.
        stats.ship_left -= 1
        print("One ship is destoryed! " + str(stats.ship_left) +" left.")
